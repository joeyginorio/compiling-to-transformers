...
from experiments.rotate.dataset import datasets, tokenize, SEQ_LEN
from experiments.rotate.models import ModelI, ModelF, interpret_out
...
_inputs = [
    ...
    "o n m l k j i h g f e d c b a | a o n m l k j i h g f e d c b",
]
