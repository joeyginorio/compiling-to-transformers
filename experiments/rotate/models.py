...
class ModelF(nn.Module):
    ...
    def forward(self, x: torch.Tensor,
        ...
        r1_postatt = self.merge(torch.cat([h1, prog_out_padded], dim=-1)) + x1
        r1 = self.mlp1(r1_postatt) + r1_postatt
        ...
        if representations:
            ...
            return logits, {"x1": x1, "h1": h1, "r1": r1_postatt, "r2": r2, "prog_in": prog_in_padded, "prog_out": prog_out_padded}
        else:
            return logits
...
class ModelI(nn.Module):
    ...
    def forward(self, x: torch.Tensor,
        ...
        if representations:
            return logits, {"x1": x1, "h1": h1, "r1": r1_postatt, "r2": r2}
        else:
            return logits
