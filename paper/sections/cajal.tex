...
\nb{\t{isVowel}} \!\quad\triangleq\quad\! \nb{\t{case}\,e\,\t{of}\,
  \begin{cases}
    \inj{0}{x_0}\Rightarrow \inj{0}{x_0}\\
    \inj{1}{x_1}\Rightarrow \inj{3}{x_0}\\
    \inj{2}{x_2}\Rightarrow \inj{3}{x_0}\\
    \inj{3}{x_3}\Rightarrow \inj{3}{x_0}\\
  \end{cases}}
  \simeq\quad
  \nb{\t{case}\,e\,\t{of}\,
  \begin{cases}
...
% YOU MUST SHOW THE DENOTATION OF THE CONDITIONAL REVERSE COMPUTATION
% AT LEAST A SIMPLER FRAGMENT, SO THAT THE MECHANICS ARE CLEAR. IT IS TOTALLY FINE
% TO DEFER TO APPENDIX AFTER THIS FOR THE COMPLETE MODEL OR EVEN JUST THE CODE.
