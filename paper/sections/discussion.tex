...
However, these linear maps are not necessarily \textit{causal}. The $\rd{i}$-th output coordinate of the linear map 
may be a function of the $\rd{j}$-th input coordinate where $\rd{j} \geq \rd{i}$. In our experiments this causes no issue. Inputs
